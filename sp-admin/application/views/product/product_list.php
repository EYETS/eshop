		...
		<div class="page-content">
			...
			<?php $this->load->view('includes/breadcrumb',$breadcrumbs); ?>
                <div class="page-toolbar">
					<a href="<?php echo site_url('product/product_add') ?>" class="btn blue">إضافة منتج جديد</a>
                </div>
            </div>
			<!-- END PAGE HEADER-->
			<div class="row">
						...
						<div class="portlet-body">
							<div class="table-responsive">
								...
								<tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo $row->pro_uid; ?></td>
                                        <td><?php echo $row->pro_title ?></td>
                                        <td><?php echo $this->product_model->getCategory($row->cat_uid) ?></td>
                                        <td><?php echo $row->pro_price ?></td>
                                        <td>
                                        	<a href="<?php echo site_url('product/product_edit/'.$row->pro_uid) ?>" class="btn btn-xs yellow"><i class="fa fa-pencil"></i> تعديل</a>
                                            <a href="<?php echo site_url('product/product_del/'.$row->pro_uid) ?>" class="btn btn-xs red"><i class="fa fa-trash-o"></i> حذف</a>
